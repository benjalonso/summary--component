...
const BirdCardsContainer = () => {
  const { content, setContent, prefetchQuery } = useContext(ContentContext);
  ...
  const { isLoading, data, isError, error, isSuccess, isPreviousData, isFetching } =
    useQuery({
...
// console.log(data)
  return (
    <>
      ...
      <Pagination pg={page} setPage={setPage} data={data} isPreviusData={isPreviousData} />
    </>
  );
};
