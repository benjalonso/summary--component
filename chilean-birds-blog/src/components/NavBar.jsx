  ...
  return (
    <>
      <div className="sticky top-0 z-10">
        <nav className="bg-green-800 dark:bg-slate-800 ">
      ...
      <div className="group my-2 grid grid-cols-8 md:max-2xl:my-4 md:max-2xl:ml-8">
        <SlMagnifier className="col-start-1 col-end-2 ml-auto mt-1 mx-1 text-teal-900  dark:text-slate-50 transition ease-in-out delay-150   focus:scale-110  duration-300" />
        <input
          type="text"
          placeholder="Search for Chilean birds"
          className="col-start-2 col-end-5 mr-10 dark:bg-slate-900 dark:border-0 bg-green-50 rounded-md border transition ease-in-out delay-150   focus:scale-110  duration-300 "
        />
      </div>
    </>
  );
